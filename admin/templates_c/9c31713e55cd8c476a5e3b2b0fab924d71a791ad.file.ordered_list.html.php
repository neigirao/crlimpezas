<?php /* Smarty version Smarty-3.1.1, created on 2013-06-02 17:03:55
         compiled from "./templates/ordered/ordered_list.html" */ ?>
<?php /*%%SmartyHeaderCode:18876104051aba52b73bc83-76789498%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9c31713e55cd8c476a5e3b2b0fab924d71a791ad' => 
    array (
      0 => './templates/ordered/ordered_list.html',
      1 => 1370203056,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18876104051aba52b73bc83-76789498',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.1',
  'unifunc' => 'content_51aba52ba1b2f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51aba52ba1b2f')) {function content_51aba52ba1b2f($_smarty_tpl) {?>
  <?php  $_config = new Smarty_Internal_Config("default.conf", $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars("ordered", 'local'); ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("include/_menu_top.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '18876104051aba52b73bc83-76789498');
content_51aba52b7d3cb($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("include/_menu_left.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '18876104051aba52b73bc83-76789498');
content_51aba52b7fee8($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("include/_msg.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '18876104051aba52b73bc83-76789498');
content_51aba52b84c3e($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "include/_msg.tpl" */?>
	...
	<form class="form-search" action="./" method="post">
		<div class="input-append">
			...
			<input class="span8" type="text" name="search_id" value="<?php echo $_smarty_tpl->tpl_vars['search_id']->value;?>
...
,"cliente":<?php echo $_smarty_tpl->tpl_vars['item']->value->clientes_id;?>
}'>
						<td>
							<a href="ordered.php?action=view&id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
">
								<?php echo sprintf('%1$04d',$_smarty_tpl->tpl_vars['item']->value->id);?>

							</a>
						</td>
						<td><?php echo $_smarty_tpl->tpl_vars['item']->value->admin_clientes->nome;?>
</td>
						<td><?php echo (($tmp = @$_smarty_tpl->tpl_vars['item']->value->servicos_cliente)===null||$tmp==='' ? '-' : $tmp);?>
</td>
						<td><?php echo $_smarty_tpl->smarty->registered_objects['dao'][0]->returnLastStatusById(array('id_pedido'=>$_smarty_tpl->tpl_vars['id']->value),$_smarty_tpl);?>
</td>
					</tr>
				<?php } ?>
			</tbody>
		</table>
		<?php $_smarty_tpl->tpl_vars['search_more'] = new Smarty_variable(("search_id=").($_smarty_tpl->tpl_vars['search_id']->value), null, 0);?>
	    <?php /*  Call merged included template "include/_pagination.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("include/_pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('search_more'=>$_smarty_tpl->tpl_vars['search_more']->value), 0, '18876104051aba52b73bc83-76789498');
content_51aba52b941c5($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('static/js/common.js', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '18876104051aba52b73bc83-76789498');
content_51aba52b9dff0($_smarty_tpl);
...
<?php }} ?><?php /* Smarty version Smarty-3.1.1, created on 2013-06-02 17:03:55
         compiled from "./templates/include/_menu_top.tpl" */ ?>
<?php if ($_valid && !is_callable('content_51aba52b7d3cb')) {function content_51aba52b7d3cb($_smarty_tpl) {?><div class="navbar navbar-inverse navbar-fixed-top">
...
</div><?php }} ?><?php /* Smarty version Smarty-3.1.1, created on 2013-06-02 17:03:55
         compiled from "./templates/include/_menu_left.tpl" */ ?>
<?php if ($_valid && !is_callable('content_51aba52b7fee8')) {function content_51aba52b7fee8($_smarty_tpl) {?><div class="well sidebar-nav">
...
</div><!--/.well --><?php }} ?><?php /* Smarty version Smarty-3.1.1, created on 2013-06-02 17:03:55
         compiled from "./templates/include/_msg.tpl" */ ?>
<?php if ($_valid && !is_callable('content_51aba52b84c3e')) {function content_51aba52b84c3e($_smarty_tpl) {?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.1, created on 2013-06-02 17:03:55
         compiled from "./templates/include/_pagination.tpl" */ ?>
<?php if ($_valid && !is_callable('content_51aba52b941c5')) {function content_51aba52b941c5($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'libs/plugins/function.math.php';
...
<?php if ($_valid && !is_callable('content_51aba52b9dff0')) {function content_51aba52b9dff0($_smarty_tpl) {?>$(document).delegate('.action-form','click',function(){
